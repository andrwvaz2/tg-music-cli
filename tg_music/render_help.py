...
class RenderHelpMixin:
    ...
    def draw_mini(self) -> None:
        ...
        right_text = "v0.1.0"
        self.screen.addnstr(0, max(0, width - len(right_text) - 1), right_text, len(right_text), header_attr | curses.A_DIM)
        ...
        if self.current_track:
            ...
            self.screen.addnstr(3, 0, f" {self.current_track.display_title}"[:width - 1], width - 1, self.color_attr(self.color_success, -1) | curses.A_BOLD)
